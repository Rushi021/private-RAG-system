...
class PrivateGptUi:
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            ".footer-project-link { display:flex; margin-left: 5px; text-decoration: auto; color: var(--body-text-color); }"
            ".footer-project-link:hover { color: #C7BAFF; }",
        ) as blocks:
            with gr.Row():
                gr.HTML(f"<div class='logo'/><img src={logo_svg} alt='VaultMind'></div")
            ...
            with gr.Row():
                gr.HTML(
                    "<div class='footer'><span class='footer-project-link'>Built by Rushi021 | </span>"
                    "<a class='footer-project-link' href='https://github.com/Rushi021/private-RAG-system'>https://github.com/Rushi021/private-RAG-system</a></div>"
                )
